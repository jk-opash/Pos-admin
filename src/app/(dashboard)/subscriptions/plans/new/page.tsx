      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-brand-muted">
            Configure limits, modules, features, and pricing for a new
            subscription tier.
          </p>
        </div>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-sm font-medium text-brand-dark">Plan Active</span>
                  <label className="flex items-center gap-3 p-3 rounded-xl border border-brand-border hover:bg-slate-50 cursor-pointer">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-brand-dark">Is Active</span>
                      <span className="text-xs text-brand-muted">Visible to businesses</span>
                    </div>
                  </label>
                </div>
              </div>
